...
export const metadata: Metadata = {
  title: "Elchef – gør det nemt at vælge den rette elaftale",
  description: "Elchef.dk hjælper dig hurtigt, gratis og uden besvær med at finde og skifte til den elaftale, der passer dig bedst. Vi viser kun elaftaler, der er værd at overveje, og tager os af hele skiftet for dig.",
  keywords: "elaftale, elpriser, skifte elaftale, sammenlign elpriser, elselskab, elleverandør",
};
        ...
        <script type="application/ld+json" suppressHydrationWarning>{`
          {
            ...
            "sameAs": [
              "https://www.facebook.com/elchef.dk",
              "https://www.instagram.com/elchef.dk/"
            ]
          }
        `}</script>
        {/* Open Graph metadata */}
        <meta property="og:title" content="Elchef – gør det nemt at vælge den rette elaftale" />
        <meta property="og:description" content="Elchef.dk hjælper dig hurtigt, gratis og uden besvær med at finde og skifte til den elaftale, der passer dig bedst. Vi viser kun elaftaler, der er værd at overveje, og tager os af hele skiftet for dig." />
        <meta property="og:image" content="https://elchef.dk/og-image.png" />
        <meta property="og:url" content="https://elchef.dk" />
        <meta property="og:type" content="website" />
        {/* Twitter Card metadata */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Elchef – gør det nemt at vælge den rette elaftale" />
        <meta name="twitter:description" content="Elchef.dk hjælper dig hurtigt, gratis og uden besvær med at finde og skifte til den elaftale, der passer dig bedst. Vi viser kun elaftaler, der er værd at overveje, og tager os af hele skiftet for dig." />
        <meta name="twitter:image" content="https://elchef.dk/og-image.png" />
